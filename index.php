...
try{
   ...
   $visitor->home();
    ...
    switch ($url[0]){
        ...
        break;
        case "inscription" : $user->inscription();
        break;
        case "creerCompte" : $visitor->creerCompte();
        break;
        case "compteValidation" : $user->compteValidation();
        break;
        case "demandeMutation" : $user->demandeMutation();
        break;
        // case "compte" : 
        //     if($security->isLog()){
        //         switch($url[1]){
        ...
        // }
        // break;
        default: throw new Exception("Aucune page trouvé");
