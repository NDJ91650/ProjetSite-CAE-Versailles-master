    ...
    <div id="contenu" class="container">
        ...
        <form id="form" action="<?= URL ?>inscription" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <select class="custom-select" required='required' name="academie_origine">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required="required" pattern="[0-9]{10}[A-Z]{3}"  name="numen" id="numen" placeholder="Exemple (inventé): 46G9987654XYZ">
            </div>
            <br>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required="required" pattern="[A-Za-zéè-ëüêâç]{2,35}" name="nom_utilisateur" id="nom_utilisateur" placeholder="Saisir votre nom">
            </div>
            <br>
            <div class="form-group">
                <label for="prenom_utilisateur">5. Prénom :</label>
                <input type="text" class="form-control" required="required" pattern="[A-Za-zéè-ëüêâç]{2,35}" name="prenom_utilisateur" id="prenom_utilisateur" placeholder="Saisir votre prénom">
            </div>
            <br>
            <div class="form-group">
                <label for="date_naissance_utilisateur">6. Date de naissance :</label>
                <input type="date" class="form-control" required="required" name="date_naissance_utilisateur" id="date_naissance_utilisateur">
            </div>
            <br>
            <div class="form-group">
                <label for="adresse_utilisateur">7. Adresse :</label>
                <input type="text" class="form-control" required="required" pattern="[0-9A-Za-zéè-ëüêâç' -]{2,35}"  name="adresse_utilisateur" id="adresse_utilisateur" placeholder="Ex: 2 rue du palais">
            </div>
            <br>
            <div class="form-group">
                <label for="cp_utilisateur">8. Code postal :</label>
                <input type="number" class="form-control" required="required" pattern="[0-9]{5}" name="cp_utilisateur" id="cp_utilisateur" placeholder="Ex: 75000">
            </div>
            <br>
            <div class="form-group">
                <label for="ville_utilisateur">9. Ville :</label>
                <input type="text" class="form-control" required="required" pattern="[A-Za-z éè-ëüêâç]{2,35}" name="ville_utilisateur" id="ville_utilisateur" placeholder="Ex: PARIS">
            </div>
            <br>
            <div class="form-group">
                ...
                <input type="tel" class="form-control" required="required" pattern="[0-9]{10}" name="num_portable_utilisateur" id="num_portable_utilisateur" placeholder="Saisir votre numéro de portable">
            </div>
            <br>
            <div class="form-group">
                <label for="num_domicile_utilisateur">11. Numéro de téléphone domicile :</label>
                <p> (Il est impératif de pouvoir vous joindre par téléphone lors des opérations du mouvement des maîtres)</p>
                <input type="tel" class="form-control" required="required" pattern="[0-9]{10}" name="num_domicile_utilisateur" id="num_domicile_utilisateur" placeholder="Saisir votre numéro de domicile">
            </div>
            <br>
            <div class="form-group">
